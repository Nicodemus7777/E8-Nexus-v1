...
import { Info, Maximize2, Layers, Hexagon, Github, Compass, X, Sigma, Grid3X3, FlaskConical, Plus, Moon, Sun, Sparkles, Zap, Sliders, Volume2, VolumeX, Focus, Activity, Orbit, Spline, Share2, RefreshCw, Telescope, FileCode, Thermometer, Network } from 'lucide-react';
...
import { Node2D, SUBGROUPS, Subgroup, LIE_GROUPS, LieGroupType, AppTheme, Vector8D, ProjectionMatrix, TopologicalDefect, DefectType, EntangledPair, Discovery, CosmicState, DecayInteraction, MeraState } from './types';
